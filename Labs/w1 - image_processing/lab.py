...
def inverted(image):
    """
    Given a greyscale image, inverts the values of the brightness of the pixels.
    ...
    Returns a new image dictionary with the pixels key containing the inverted values
    for pixel brightness.
    """
